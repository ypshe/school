						...
						<ul>
							<li>
								<span style="width:536px;">
									<a href="">
										<img class="pro" src="Pc/img/img.jpg">
										<b>
											<h4 title="【畜牧兽医】">【畜牧兽医】</h4>
											<i>畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医畜牧兽医</i>
										</b>
									</a>
								</span>
								<span style="width:280px;" class="choose2">
									<dl>
										<dt class="value">
											兽医基础
										</dt>
										<dd style="display: block;">
											<a href="javascript:;">畜禽生产技术</a>
											<a href="javascript:;">畜禽繁育技术</a>
											<a href="javascript:;">畜禽营养与饲料加工技术</a>
											<a href="javascript:;">畜禽解刨生理</a>
										</dd>
									</dl>
								</span>
								<span style="width:150px;text-align: center;">120</span>
								<span style="width:150px;text-align: center;color:#e70a2e">￥88.00</span>
							</li>
						</ul>
					</div>
					<div class="prolistbo">
