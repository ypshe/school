...
<html class="bgbai">
	...
	<body class="bgbai">
		...
		<div class="header bglan overflow textcenter wbai">
			...
			<h3 class="sanwu bai textcenter">注册</h3>
		</div>
		<!--登录头部-->
		<!--登录主体-->
		<article>
			...
			<div class="maindl">
				<form id="form" action="{{url('/wap/register')}}" method="post">
					{{csrf_field()}}
					<dl class="overflow">
						...
						<dd class="fl">
							<input class="wbai h2 liu" id="shenfenzheng" value="{{ old('cardId') }}" name="cardId" type="text" placeholder="请输入身份证号" />
						</dd>
					</dl>
					<dl class="overflow">
						<dt class="fl textcenter">
						...
						<dd class="fl">
							<input class="wbai h2 liu" id="mima" name="password" value="{{ old('password') }}" type="password" placeholder="设置密码" />
						</dd>
					</dl>
					<dl class="overflow">
						<dt class="fl textcenter">
						...
						<dd class="fl">
							<input class="wbai h2 liu" id="mima2" value="{{ old('password_confirmation') }}" name="password_confirmation" type="password" placeholder="再次确认密码" />
						</dd>
					</dl>
					...
					<div class="btn" style="margin-top:8.2vw" id="zhuce">
						<input class="wbai bai h2" type="button" value="注册" />
					</div>
					{{--<div class="more">--}}
